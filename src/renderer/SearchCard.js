...
export const SearchCard = ({ 
  ...
  const usingCloseAndShuffle = gameState.searchCardConfig.usingCloseAndShuffle; 
  const sourceZone = gameState.searchCardConfig.sourceZone;
  const targetZones= gameState.searchCardConfig.targetZones;
